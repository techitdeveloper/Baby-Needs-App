...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addItem(Item item)
    {
        ...
        values.put(Constants.KEY_COLOUR, item.getItemColour());
    ...
    public Item getItem(int id)
    {
        ...
        Cursor cursor = db.query(Constants.TABLE_NAME,
                new String[] {Constants.KEY_ID, Constants.KEY_ITEM, Constants.KEY_COLOUR, Constants.KEY_QTY_NUMBER, Constants.KEY_ITEM_SIZE, Constants.KEY_DATE},
                Constants.KEY_ID + "=?",
        ...
        if (cursor != null) {
            ...
            item.setItemColour(cursor.getString(cursor.getColumnIndex(Constants.KEY_COLOUR)));
